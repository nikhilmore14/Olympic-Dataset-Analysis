...
summer_df.plot.bar(x='Country_Name',y='Total_Summer',title='Country wise Total Summer')
winter_df.plot.bar(x='Country_Name',y='Total_Winter',title='Country wise Total Winter')
top_df.plot.bar(x='Country_Name',y='Total_Medals',title='Country wise Total')
#plot.show()
